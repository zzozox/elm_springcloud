...
onMounted(() => {
  user.value = getUser();
  business.value.businessId = route.query.businessId;
  post(`/business/byBusinessId/${business.value.businessId}`,
...
const editBusiness = () => {
  ...
  post(`/business/updateBusiness`, {
    ...
    registerTime: business.value.registerTime,
...
<template>
  <div class="wrapper">
    ...
    <div class="button-add">
      <button @click="editBusiness">更新</button>
    </div>
    <!-- 底部菜单部分 -->
    <Footer></Footer>
  </div>
